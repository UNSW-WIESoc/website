...
export default function Program() {
  ...
  const impIcon1: IconTextProps = {
    icon: '/programs/WomanProfile.svg',
    text: 'Industry Mentors',
  };

  const impIcon2: IconTextProps = {
    icon: '/programs/Learning.svg',
    text: 'Develop Professionally',
  };
  ...
  const impIcon4: IconTextProps = {
    icon: '/programs/ConnectedPeople.svg',
  ...
  return (
    <Box>
      ...
      <Stack direction='column' alignItems='center' spacing={10} pb={10}>
        <Stack>
          <Typography level='h1' pt={3}>Annual Programs</Typography>
